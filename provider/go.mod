module github.com/jacobbmay/pulumi-nutanix/provider
...
replace (
	...
	github.com/terraform-providers/terraform-provider-nutanix => github.com/nutanix/terraform-provider-nutanix v1.9.3
)

require (
	github.com/pulumi/pulumi-terraform-bridge/v3 v3.60.1
	github.com/pulumi/pulumi/sdk/v3 v3.81.0
	github.com/terraform-providers/terraform-provider-nutanix v1.9.3
)
