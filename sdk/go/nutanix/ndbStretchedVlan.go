...
func (i *NdbStretchedVlan) ToOutput(ctx context.Context) pulumix.Output[*NdbStretchedVlan] {
	return pulumix.Output[*NdbStretchedVlan]{
		OutputState: i.ToNdbStretchedVlanOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbStretchedVlanArray) ToOutput(ctx context.Context) pulumix.Output[[]*NdbStretchedVlan] {
	return pulumix.Output[[]*NdbStretchedVlan]{
		OutputState: i.ToNdbStretchedVlanArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbStretchedVlanMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbStretchedVlan] {
	return pulumix.Output[map[string]*NdbStretchedVlan]{
		OutputState: i.ToNdbStretchedVlanMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o NdbStretchedVlanOutput) ToOutput(ctx context.Context) pulumix.Output[*NdbStretchedVlan] {
	return pulumix.Output[*NdbStretchedVlan]{
...
func (o NdbStretchedVlanArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*NdbStretchedVlan] {
	return pulumix.Output[[]*NdbStretchedVlan]{
		OutputState: o.OutputState,
	}
}
...
func (o NdbStretchedVlanMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbStretchedVlan] {
	return pulumix.Output[map[string]*NdbStretchedVlan]{
		OutputState: o.OutputState,
	}
}
