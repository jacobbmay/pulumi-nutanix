...
func (i *NdbProfile) ToOutput(ctx context.Context) pulumix.Output[*NdbProfile] {
	return pulumix.Output[*NdbProfile]{
		OutputState: i.ToNdbProfileOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbProfileArray) ToOutput(ctx context.Context) pulumix.Output[[]*NdbProfile] {
	return pulumix.Output[[]*NdbProfile]{
		OutputState: i.ToNdbProfileArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbProfileMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbProfile] {
	return pulumix.Output[map[string]*NdbProfile]{
		OutputState: i.ToNdbProfileMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o NdbProfileOutput) ToOutput(ctx context.Context) pulumix.Output[*NdbProfile] {
	return pulumix.Output[*NdbProfile]{
...
func (o NdbProfileArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*NdbProfile] {
	return pulumix.Output[[]*NdbProfile]{
		OutputState: o.OutputState,
	}
}
...
func (o NdbProfileMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbProfile] {
	return pulumix.Output[map[string]*NdbProfile]{
		OutputState: o.OutputState,
	}
}
