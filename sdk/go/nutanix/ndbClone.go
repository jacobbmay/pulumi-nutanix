...
func (i *NdbClone) ToOutput(ctx context.Context) pulumix.Output[*NdbClone] {
	return pulumix.Output[*NdbClone]{
		OutputState: i.ToNdbCloneOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbCloneArray) ToOutput(ctx context.Context) pulumix.Output[[]*NdbClone] {
	return pulumix.Output[[]*NdbClone]{
		OutputState: i.ToNdbCloneArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbCloneMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbClone] {
	return pulumix.Output[map[string]*NdbClone]{
		OutputState: i.ToNdbCloneMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o NdbCloneOutput) ToOutput(ctx context.Context) pulumix.Output[*NdbClone] {
	return pulumix.Output[*NdbClone]{
...
func (o NdbCloneArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*NdbClone] {
	return pulumix.Output[[]*NdbClone]{
		OutputState: o.OutputState,
	}
}
...
func (o NdbCloneMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbClone] {
	return pulumix.Output[map[string]*NdbClone]{
		OutputState: o.OutputState,
	}
}
