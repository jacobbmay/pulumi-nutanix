...
func (i *NdbScaleDatabase) ToOutput(ctx context.Context) pulumix.Output[*NdbScaleDatabase] {
	return pulumix.Output[*NdbScaleDatabase]{
		OutputState: i.ToNdbScaleDatabaseOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbScaleDatabaseArray) ToOutput(ctx context.Context) pulumix.Output[[]*NdbScaleDatabase] {
	return pulumix.Output[[]*NdbScaleDatabase]{
		OutputState: i.ToNdbScaleDatabaseArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbScaleDatabaseMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbScaleDatabase] {
	return pulumix.Output[map[string]*NdbScaleDatabase]{
		OutputState: i.ToNdbScaleDatabaseMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o NdbScaleDatabaseOutput) ToOutput(ctx context.Context) pulumix.Output[*NdbScaleDatabase] {
	return pulumix.Output[*NdbScaleDatabase]{
...
func (o NdbScaleDatabaseArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*NdbScaleDatabase] {
	return pulumix.Output[[]*NdbScaleDatabase]{
		OutputState: o.OutputState,
	}
}
...
func (o NdbScaleDatabaseMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbScaleDatabase] {
	return pulumix.Output[map[string]*NdbScaleDatabase]{
		OutputState: o.OutputState,
	}
}
