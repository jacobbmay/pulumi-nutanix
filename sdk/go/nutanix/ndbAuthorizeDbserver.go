...
func (i *NdbAuthorizeDbserver) ToOutput(ctx context.Context) pulumix.Output[*NdbAuthorizeDbserver] {
	return pulumix.Output[*NdbAuthorizeDbserver]{
		OutputState: i.ToNdbAuthorizeDbserverOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbAuthorizeDbserverArray) ToOutput(ctx context.Context) pulumix.Output[[]*NdbAuthorizeDbserver] {
	return pulumix.Output[[]*NdbAuthorizeDbserver]{
		OutputState: i.ToNdbAuthorizeDbserverArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbAuthorizeDbserverMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbAuthorizeDbserver] {
	return pulumix.Output[map[string]*NdbAuthorizeDbserver]{
		OutputState: i.ToNdbAuthorizeDbserverMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o NdbAuthorizeDbserverOutput) ToOutput(ctx context.Context) pulumix.Output[*NdbAuthorizeDbserver] {
	return pulumix.Output[*NdbAuthorizeDbserver]{
...
func (o NdbAuthorizeDbserverArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*NdbAuthorizeDbserver] {
	return pulumix.Output[[]*NdbAuthorizeDbserver]{
		OutputState: o.OutputState,
	}
}
...
func (o NdbAuthorizeDbserverMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbAuthorizeDbserver] {
	return pulumix.Output[map[string]*NdbAuthorizeDbserver]{
		OutputState: o.OutputState,
	}
}
