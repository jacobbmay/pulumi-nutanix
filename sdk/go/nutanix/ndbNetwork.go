...
func (i *NdbNetwork) ToOutput(ctx context.Context) pulumix.Output[*NdbNetwork] {
	return pulumix.Output[*NdbNetwork]{
		OutputState: i.ToNdbNetworkOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbNetworkArray) ToOutput(ctx context.Context) pulumix.Output[[]*NdbNetwork] {
	return pulumix.Output[[]*NdbNetwork]{
		OutputState: i.ToNdbNetworkArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbNetworkMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbNetwork] {
	return pulumix.Output[map[string]*NdbNetwork]{
		OutputState: i.ToNdbNetworkMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o NdbNetworkOutput) ToOutput(ctx context.Context) pulumix.Output[*NdbNetwork] {
	return pulumix.Output[*NdbNetwork]{
...
func (o NdbNetworkArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*NdbNetwork] {
	return pulumix.Output[[]*NdbNetwork]{
		OutputState: o.OutputState,
	}
}
...
func (o NdbNetworkMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbNetwork] {
	return pulumix.Output[map[string]*NdbNetwork]{
		OutputState: o.OutputState,
	}
}
