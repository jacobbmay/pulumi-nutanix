...
func (i *NdbLinkedDatabases) ToOutput(ctx context.Context) pulumix.Output[*NdbLinkedDatabases] {
	return pulumix.Output[*NdbLinkedDatabases]{
		OutputState: i.ToNdbLinkedDatabasesOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbLinkedDatabasesArray) ToOutput(ctx context.Context) pulumix.Output[[]*NdbLinkedDatabases] {
	return pulumix.Output[[]*NdbLinkedDatabases]{
		OutputState: i.ToNdbLinkedDatabasesArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbLinkedDatabasesMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbLinkedDatabases] {
	return pulumix.Output[map[string]*NdbLinkedDatabases]{
		OutputState: i.ToNdbLinkedDatabasesMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o NdbLinkedDatabasesOutput) ToOutput(ctx context.Context) pulumix.Output[*NdbLinkedDatabases] {
	return pulumix.Output[*NdbLinkedDatabases]{
...
func (o NdbLinkedDatabasesArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*NdbLinkedDatabases] {
	return pulumix.Output[[]*NdbLinkedDatabases]{
		OutputState: o.OutputState,
	}
}
...
func (o NdbLinkedDatabasesMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbLinkedDatabases] {
	return pulumix.Output[map[string]*NdbLinkedDatabases]{
		OutputState: o.OutputState,
	}
}
