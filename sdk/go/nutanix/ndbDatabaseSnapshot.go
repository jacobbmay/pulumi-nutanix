...
func (i *NdbDatabaseSnapshot) ToOutput(ctx context.Context) pulumix.Output[*NdbDatabaseSnapshot] {
	return pulumix.Output[*NdbDatabaseSnapshot]{
		OutputState: i.ToNdbDatabaseSnapshotOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbDatabaseSnapshotArray) ToOutput(ctx context.Context) pulumix.Output[[]*NdbDatabaseSnapshot] {
	return pulumix.Output[[]*NdbDatabaseSnapshot]{
		OutputState: i.ToNdbDatabaseSnapshotArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbDatabaseSnapshotMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbDatabaseSnapshot] {
	return pulumix.Output[map[string]*NdbDatabaseSnapshot]{
		OutputState: i.ToNdbDatabaseSnapshotMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o NdbDatabaseSnapshotOutput) ToOutput(ctx context.Context) pulumix.Output[*NdbDatabaseSnapshot] {
	return pulumix.Output[*NdbDatabaseSnapshot]{
...
func (o NdbDatabaseSnapshotArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*NdbDatabaseSnapshot] {
	return pulumix.Output[[]*NdbDatabaseSnapshot]{
		OutputState: o.OutputState,
	}
}
...
func (o NdbDatabaseSnapshotMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbDatabaseSnapshot] {
	return pulumix.Output[map[string]*NdbDatabaseSnapshot]{
		OutputState: o.OutputState,
	}
}
