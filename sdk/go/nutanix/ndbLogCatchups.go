...
func (i *NdbLogCatchups) ToOutput(ctx context.Context) pulumix.Output[*NdbLogCatchups] {
	return pulumix.Output[*NdbLogCatchups]{
		OutputState: i.ToNdbLogCatchupsOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbLogCatchupsArray) ToOutput(ctx context.Context) pulumix.Output[[]*NdbLogCatchups] {
	return pulumix.Output[[]*NdbLogCatchups]{
		OutputState: i.ToNdbLogCatchupsArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbLogCatchupsMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbLogCatchups] {
	return pulumix.Output[map[string]*NdbLogCatchups]{
		OutputState: i.ToNdbLogCatchupsMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o NdbLogCatchupsOutput) ToOutput(ctx context.Context) pulumix.Output[*NdbLogCatchups] {
	return pulumix.Output[*NdbLogCatchups]{
...
func (o NdbLogCatchupsArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*NdbLogCatchups] {
	return pulumix.Output[[]*NdbLogCatchups]{
		OutputState: o.OutputState,
	}
}
...
func (o NdbLogCatchupsMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbLogCatchups] {
	return pulumix.Output[map[string]*NdbLogCatchups]{
		OutputState: o.OutputState,
	}
}
