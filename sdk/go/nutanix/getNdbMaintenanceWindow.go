...
func (o LookupNdbMaintenanceWindowResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupNdbMaintenanceWindowResult] {
	return pulumix.Output[LookupNdbMaintenanceWindowResult]{
