...
func (i *NdbSla) ToOutput(ctx context.Context) pulumix.Output[*NdbSla] {
	return pulumix.Output[*NdbSla]{
		OutputState: i.ToNdbSlaOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbSlaArray) ToOutput(ctx context.Context) pulumix.Output[[]*NdbSla] {
	return pulumix.Output[[]*NdbSla]{
		OutputState: i.ToNdbSlaArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbSlaMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbSla] {
	return pulumix.Output[map[string]*NdbSla]{
		OutputState: i.ToNdbSlaMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o NdbSlaOutput) ToOutput(ctx context.Context) pulumix.Output[*NdbSla] {
	return pulumix.Output[*NdbSla]{
...
func (o NdbSlaArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*NdbSla] {
	return pulumix.Output[[]*NdbSla]{
		OutputState: o.OutputState,
	}
}
...
func (o NdbSlaMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbSla] {
	return pulumix.Output[map[string]*NdbSla]{
		OutputState: o.OutputState,
	}
}
