...
func (i *NdbSoftwareVersionProfile) ToOutput(ctx context.Context) pulumix.Output[*NdbSoftwareVersionProfile] {
	return pulumix.Output[*NdbSoftwareVersionProfile]{
		OutputState: i.ToNdbSoftwareVersionProfileOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbSoftwareVersionProfileArray) ToOutput(ctx context.Context) pulumix.Output[[]*NdbSoftwareVersionProfile] {
	return pulumix.Output[[]*NdbSoftwareVersionProfile]{
		OutputState: i.ToNdbSoftwareVersionProfileArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbSoftwareVersionProfileMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbSoftwareVersionProfile] {
	return pulumix.Output[map[string]*NdbSoftwareVersionProfile]{
		OutputState: i.ToNdbSoftwareVersionProfileMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o NdbSoftwareVersionProfileOutput) ToOutput(ctx context.Context) pulumix.Output[*NdbSoftwareVersionProfile] {
	return pulumix.Output[*NdbSoftwareVersionProfile]{
...
func (o NdbSoftwareVersionProfileArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*NdbSoftwareVersionProfile] {
	return pulumix.Output[[]*NdbSoftwareVersionProfile]{
		OutputState: o.OutputState,
	}
}
...
func (o NdbSoftwareVersionProfileMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbSoftwareVersionProfile] {
	return pulumix.Output[map[string]*NdbSoftwareVersionProfile]{
		OutputState: o.OutputState,
	}
}
