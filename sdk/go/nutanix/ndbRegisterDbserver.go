...
func (i *NdbRegisterDbserver) ToOutput(ctx context.Context) pulumix.Output[*NdbRegisterDbserver] {
	return pulumix.Output[*NdbRegisterDbserver]{
		OutputState: i.ToNdbRegisterDbserverOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbRegisterDbserverArray) ToOutput(ctx context.Context) pulumix.Output[[]*NdbRegisterDbserver] {
	return pulumix.Output[[]*NdbRegisterDbserver]{
		OutputState: i.ToNdbRegisterDbserverArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbRegisterDbserverMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbRegisterDbserver] {
	return pulumix.Output[map[string]*NdbRegisterDbserver]{
		OutputState: i.ToNdbRegisterDbserverMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o NdbRegisterDbserverOutput) ToOutput(ctx context.Context) pulumix.Output[*NdbRegisterDbserver] {
	return pulumix.Output[*NdbRegisterDbserver]{
...
func (o NdbRegisterDbserverArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*NdbRegisterDbserver] {
	return pulumix.Output[[]*NdbRegisterDbserver]{
		OutputState: o.OutputState,
	}
}
...
func (o NdbRegisterDbserverMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbRegisterDbserver] {
	return pulumix.Output[map[string]*NdbRegisterDbserver]{
		OutputState: o.OutputState,
	}
}
