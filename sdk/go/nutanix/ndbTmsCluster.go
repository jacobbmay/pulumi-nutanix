...
func (i *NdbTmsCluster) ToOutput(ctx context.Context) pulumix.Output[*NdbTmsCluster] {
	return pulumix.Output[*NdbTmsCluster]{
		OutputState: i.ToNdbTmsClusterOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbTmsClusterArray) ToOutput(ctx context.Context) pulumix.Output[[]*NdbTmsCluster] {
	return pulumix.Output[[]*NdbTmsCluster]{
		OutputState: i.ToNdbTmsClusterArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbTmsClusterMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbTmsCluster] {
	return pulumix.Output[map[string]*NdbTmsCluster]{
		OutputState: i.ToNdbTmsClusterMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o NdbTmsClusterOutput) ToOutput(ctx context.Context) pulumix.Output[*NdbTmsCluster] {
	return pulumix.Output[*NdbTmsCluster]{
...
func (o NdbTmsClusterArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*NdbTmsCluster] {
	return pulumix.Output[[]*NdbTmsCluster]{
		OutputState: o.OutputState,
	}
}
...
func (o NdbTmsClusterMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbTmsCluster] {
	return pulumix.Output[map[string]*NdbTmsCluster]{
		OutputState: o.OutputState,
	}
}
