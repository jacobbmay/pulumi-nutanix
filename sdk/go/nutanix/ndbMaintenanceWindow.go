...
func (i *NdbMaintenanceWindow) ToOutput(ctx context.Context) pulumix.Output[*NdbMaintenanceWindow] {
	return pulumix.Output[*NdbMaintenanceWindow]{
		OutputState: i.ToNdbMaintenanceWindowOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbMaintenanceWindowArray) ToOutput(ctx context.Context) pulumix.Output[[]*NdbMaintenanceWindow] {
	return pulumix.Output[[]*NdbMaintenanceWindow]{
		OutputState: i.ToNdbMaintenanceWindowArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbMaintenanceWindowMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbMaintenanceWindow] {
	return pulumix.Output[map[string]*NdbMaintenanceWindow]{
		OutputState: i.ToNdbMaintenanceWindowMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o NdbMaintenanceWindowOutput) ToOutput(ctx context.Context) pulumix.Output[*NdbMaintenanceWindow] {
	return pulumix.Output[*NdbMaintenanceWindow]{
...
func (o NdbMaintenanceWindowArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*NdbMaintenanceWindow] {
	return pulumix.Output[[]*NdbMaintenanceWindow]{
		OutputState: o.OutputState,
	}
}
...
func (o NdbMaintenanceWindowMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbMaintenanceWindow] {
	return pulumix.Output[map[string]*NdbMaintenanceWindow]{
		OutputState: o.OutputState,
	}
}
