...
func (i *KarbonWorkerNodepool) ToOutput(ctx context.Context) pulumix.Output[*KarbonWorkerNodepool] {
	return pulumix.Output[*KarbonWorkerNodepool]{
		OutputState: i.ToKarbonWorkerNodepoolOutputWithContext(ctx).OutputState,
	}
}
...
func (i KarbonWorkerNodepoolArray) ToOutput(ctx context.Context) pulumix.Output[[]*KarbonWorkerNodepool] {
	return pulumix.Output[[]*KarbonWorkerNodepool]{
		OutputState: i.ToKarbonWorkerNodepoolArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i KarbonWorkerNodepoolMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*KarbonWorkerNodepool] {
	return pulumix.Output[map[string]*KarbonWorkerNodepool]{
		OutputState: i.ToKarbonWorkerNodepoolMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o KarbonWorkerNodepoolOutput) ToOutput(ctx context.Context) pulumix.Output[*KarbonWorkerNodepool] {
	return pulumix.Output[*KarbonWorkerNodepool]{
...
func (o KarbonWorkerNodepoolArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*KarbonWorkerNodepool] {
	return pulumix.Output[[]*KarbonWorkerNodepool]{
		OutputState: o.OutputState,
	}
}
...
func (o KarbonWorkerNodepoolMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*KarbonWorkerNodepool] {
	return pulumix.Output[map[string]*KarbonWorkerNodepool]{
		OutputState: o.OutputState,
	}
}
