...
func (i *NdbMaintenanceTask) ToOutput(ctx context.Context) pulumix.Output[*NdbMaintenanceTask] {
	return pulumix.Output[*NdbMaintenanceTask]{
		OutputState: i.ToNdbMaintenanceTaskOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbMaintenanceTaskArray) ToOutput(ctx context.Context) pulumix.Output[[]*NdbMaintenanceTask] {
	return pulumix.Output[[]*NdbMaintenanceTask]{
		OutputState: i.ToNdbMaintenanceTaskArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbMaintenanceTaskMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbMaintenanceTask] {
	return pulumix.Output[map[string]*NdbMaintenanceTask]{
		OutputState: i.ToNdbMaintenanceTaskMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o NdbMaintenanceTaskOutput) ToOutput(ctx context.Context) pulumix.Output[*NdbMaintenanceTask] {
	return pulumix.Output[*NdbMaintenanceTask]{
...
func (o NdbMaintenanceTaskArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*NdbMaintenanceTask] {
	return pulumix.Output[[]*NdbMaintenanceTask]{
		OutputState: o.OutputState,
	}
}
...
func (o NdbMaintenanceTaskMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbMaintenanceTask] {
	return pulumix.Output[map[string]*NdbMaintenanceTask]{
		OutputState: o.OutputState,
	}
}
