...
func (i *NdbTag) ToOutput(ctx context.Context) pulumix.Output[*NdbTag] {
	return pulumix.Output[*NdbTag]{
		OutputState: i.ToNdbTagOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbTagArray) ToOutput(ctx context.Context) pulumix.Output[[]*NdbTag] {
	return pulumix.Output[[]*NdbTag]{
		OutputState: i.ToNdbTagArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbTagMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbTag] {
	return pulumix.Output[map[string]*NdbTag]{
		OutputState: i.ToNdbTagMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o NdbTagOutput) ToOutput(ctx context.Context) pulumix.Output[*NdbTag] {
	return pulumix.Output[*NdbTag]{
...
func (o NdbTagArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*NdbTag] {
	return pulumix.Output[[]*NdbTag]{
		OutputState: o.OutputState,
	}
}
...
func (o NdbTagMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbTag] {
	return pulumix.Output[map[string]*NdbTag]{
		OutputState: o.OutputState,
	}
}
