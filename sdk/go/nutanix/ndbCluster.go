...
func (i *NdbCluster) ToOutput(ctx context.Context) pulumix.Output[*NdbCluster] {
	return pulumix.Output[*NdbCluster]{
		OutputState: i.ToNdbClusterOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbClusterArray) ToOutput(ctx context.Context) pulumix.Output[[]*NdbCluster] {
	return pulumix.Output[[]*NdbCluster]{
		OutputState: i.ToNdbClusterArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbClusterMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbCluster] {
	return pulumix.Output[map[string]*NdbCluster]{
		OutputState: i.ToNdbClusterMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o NdbClusterOutput) ToOutput(ctx context.Context) pulumix.Output[*NdbCluster] {
	return pulumix.Output[*NdbCluster]{
...
func (o NdbClusterArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*NdbCluster] {
	return pulumix.Output[[]*NdbCluster]{
		OutputState: o.OutputState,
	}
}
...
func (o NdbClusterMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbCluster] {
	return pulumix.Output[map[string]*NdbCluster]{
		OutputState: o.OutputState,
	}
}
