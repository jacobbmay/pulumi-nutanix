...
func (o GetNdbNetworkAvailableIpsResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetNdbNetworkAvailableIpsResult] {
	return pulumix.Output[GetNdbNetworkAvailableIpsResult]{
