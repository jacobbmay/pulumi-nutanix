...
func (i *NdbRegisterDatabase) ToOutput(ctx context.Context) pulumix.Output[*NdbRegisterDatabase] {
	return pulumix.Output[*NdbRegisterDatabase]{
		OutputState: i.ToNdbRegisterDatabaseOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbRegisterDatabaseArray) ToOutput(ctx context.Context) pulumix.Output[[]*NdbRegisterDatabase] {
	return pulumix.Output[[]*NdbRegisterDatabase]{
		OutputState: i.ToNdbRegisterDatabaseArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbRegisterDatabaseMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbRegisterDatabase] {
	return pulumix.Output[map[string]*NdbRegisterDatabase]{
		OutputState: i.ToNdbRegisterDatabaseMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o NdbRegisterDatabaseOutput) ToOutput(ctx context.Context) pulumix.Output[*NdbRegisterDatabase] {
	return pulumix.Output[*NdbRegisterDatabase]{
...
func (o NdbRegisterDatabaseArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*NdbRegisterDatabase] {
	return pulumix.Output[[]*NdbRegisterDatabase]{
		OutputState: o.OutputState,
	}
}
...
func (o NdbRegisterDatabaseMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbRegisterDatabase] {
	return pulumix.Output[map[string]*NdbRegisterDatabase]{
		OutputState: o.OutputState,
	}
}
