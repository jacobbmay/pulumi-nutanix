...
func (i *NdbCloneRefresh) ToOutput(ctx context.Context) pulumix.Output[*NdbCloneRefresh] {
	return pulumix.Output[*NdbCloneRefresh]{
		OutputState: i.ToNdbCloneRefreshOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbCloneRefreshArray) ToOutput(ctx context.Context) pulumix.Output[[]*NdbCloneRefresh] {
	return pulumix.Output[[]*NdbCloneRefresh]{
		OutputState: i.ToNdbCloneRefreshArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbCloneRefreshMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbCloneRefresh] {
	return pulumix.Output[map[string]*NdbCloneRefresh]{
		OutputState: i.ToNdbCloneRefreshMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o NdbCloneRefreshOutput) ToOutput(ctx context.Context) pulumix.Output[*NdbCloneRefresh] {
	return pulumix.Output[*NdbCloneRefresh]{
...
func (o NdbCloneRefreshArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*NdbCloneRefresh] {
	return pulumix.Output[[]*NdbCloneRefresh]{
		OutputState: o.OutputState,
	}
}
...
func (o NdbCloneRefreshMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbCloneRefresh] {
	return pulumix.Output[map[string]*NdbCloneRefresh]{
		OutputState: o.OutputState,
	}
}
