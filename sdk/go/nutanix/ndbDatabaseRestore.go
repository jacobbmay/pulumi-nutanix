...
func (i *NdbDatabaseRestore) ToOutput(ctx context.Context) pulumix.Output[*NdbDatabaseRestore] {
	return pulumix.Output[*NdbDatabaseRestore]{
		OutputState: i.ToNdbDatabaseRestoreOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbDatabaseRestoreArray) ToOutput(ctx context.Context) pulumix.Output[[]*NdbDatabaseRestore] {
	return pulumix.Output[[]*NdbDatabaseRestore]{
		OutputState: i.ToNdbDatabaseRestoreArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbDatabaseRestoreMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbDatabaseRestore] {
	return pulumix.Output[map[string]*NdbDatabaseRestore]{
		OutputState: i.ToNdbDatabaseRestoreMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o NdbDatabaseRestoreOutput) ToOutput(ctx context.Context) pulumix.Output[*NdbDatabaseRestore] {
	return pulumix.Output[*NdbDatabaseRestore]{
...
func (o NdbDatabaseRestoreArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*NdbDatabaseRestore] {
	return pulumix.Output[[]*NdbDatabaseRestore]{
		OutputState: o.OutputState,
	}
}
...
func (o NdbDatabaseRestoreMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbDatabaseRestore] {
	return pulumix.Output[map[string]*NdbDatabaseRestore]{
		OutputState: o.OutputState,
	}
}
