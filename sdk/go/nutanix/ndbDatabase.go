...
func (i *NdbDatabase) ToOutput(ctx context.Context) pulumix.Output[*NdbDatabase] {
	return pulumix.Output[*NdbDatabase]{
		OutputState: i.ToNdbDatabaseOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbDatabaseArray) ToOutput(ctx context.Context) pulumix.Output[[]*NdbDatabase] {
	return pulumix.Output[[]*NdbDatabase]{
		OutputState: i.ToNdbDatabaseArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbDatabaseMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbDatabase] {
	return pulumix.Output[map[string]*NdbDatabase]{
		OutputState: i.ToNdbDatabaseMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o NdbDatabaseOutput) ToOutput(ctx context.Context) pulumix.Output[*NdbDatabase] {
	return pulumix.Output[*NdbDatabase]{
...
func (o NdbDatabaseArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*NdbDatabase] {
	return pulumix.Output[[]*NdbDatabase]{
		OutputState: o.OutputState,
	}
}
...
func (o NdbDatabaseMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbDatabase] {
	return pulumix.Output[map[string]*NdbDatabase]{
		OutputState: o.OutputState,
	}
}
