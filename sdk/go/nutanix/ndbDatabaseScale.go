...
func (i *NdbDatabaseScale) ToOutput(ctx context.Context) pulumix.Output[*NdbDatabaseScale] {
	return pulumix.Output[*NdbDatabaseScale]{
		OutputState: i.ToNdbDatabaseScaleOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbDatabaseScaleArray) ToOutput(ctx context.Context) pulumix.Output[[]*NdbDatabaseScale] {
	return pulumix.Output[[]*NdbDatabaseScale]{
		OutputState: i.ToNdbDatabaseScaleArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i NdbDatabaseScaleMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbDatabaseScale] {
	return pulumix.Output[map[string]*NdbDatabaseScale]{
		OutputState: i.ToNdbDatabaseScaleMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o NdbDatabaseScaleOutput) ToOutput(ctx context.Context) pulumix.Output[*NdbDatabaseScale] {
	return pulumix.Output[*NdbDatabaseScale]{
...
func (o NdbDatabaseScaleArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*NdbDatabaseScale] {
	return pulumix.Output[[]*NdbDatabaseScale]{
		OutputState: o.OutputState,
	}
}
...
func (o NdbDatabaseScaleMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*NdbDatabaseScale] {
	return pulumix.Output[map[string]*NdbDatabaseScale]{
		OutputState: o.OutputState,
	}
}
