...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `nutanix` with the `NAME` of your provider.
...
├── config.yaml
├── metadata.json
├── pulumi-nutanix_darwin_amd64_v1
│   └── pulumi-resource-nutanix
├── pulumi-nutanix_darwin_arm64
│   └── pulumi-resource-nutanix
├── pulumi-nutanix_linux_amd64_v1
│   └── pulumi-resource-nutanix
├── pulumi-nutanix_linux_arm64
│   └── pulumi-resource-nutanix
├── pulumi-nutanix_windows_amd64_v1
│   └── pulumi-resource-nutanix.exe
└── pulumi-nutanix_windows_arm64
    └── pulumi-resource-nutanix.exe
```
