...
class NdbDatabaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['NdbDatabaseTagArgs']]] tags: - (Optional) tags
...
class _NdbDatabaseState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] nxclusterid: - (Optional) Cluster ID for DB server VM
        :param pulumi.Input['NdbDatabasePostgresqlInfoArgs'] postgresql_info: - (Optional) action arguments for postgress type database.
        :param pulumi.Input[Sequence[pulumi.Input['NdbDatabasePropertyArgs']]] properties: - (Optional) list of additional properties
        :param pulumi.Input[bool] remove: - (Optional) Unregister the database from NDB. Default value is true
        :param pulumi.Input[bool] soft_remove: - (Optional) Soft remove. Default will be false
        :param pulumi.Input[str] softwareprofileid: - (Optional) ID of software profile
        :param pulumi.Input[str] softwareprofileversionid: - (Optional) ID of version in software profile
...
class NdbDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * `Update` : - Currently only update of instance's name and description is supported using this resource
        ...
        :param pulumi.Input[str] softwareprofileversionid: - (Optional) ID of version in software profile
        :param pulumi.Input[str] sshpublickey: - (Optional) public key for ssh access to DB server VM
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NdbDatabaseTagArgs']]]] tags: - (Optional) tags
    ...
    def get(resource_name: str,
        ...
        :param pulumi.Input[str] nxclusterid: - (Optional) Cluster ID for DB server VM
        :param pulumi.Input[pulumi.InputType['NdbDatabasePostgresqlInfoArgs']] postgresql_info: - (Optional) action arguments for postgress type database.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NdbDatabasePropertyArgs']]]] properties: - (Optional) list of additional properties
        :param pulumi.Input[bool] remove: - (Optional) Unregister the database from NDB. Default value is true
        :param pulumi.Input[bool] soft_remove: - (Optional) Soft remove. Default will be false
        :param pulumi.Input[str] softwareprofileid: - (Optional) ID of software profile
        :param pulumi.Input[str] softwareprofileversionid: - (Optional) ID of version in software profile
