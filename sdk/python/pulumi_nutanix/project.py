...
class ProjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ProjectDefaultEnvironmentReferenceArgs'] default_environment_reference: Reference to a environment.
...
class Project(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] cluster_uuid: The UUID of cluster. (Required when using project_internal flag).
        :param pulumi.Input[pulumi.InputType['ProjectDefaultEnvironmentReferenceArgs']] default_environment_reference: Reference to a environment.
               * `default_environment_reference.kind` - (Optional) The kind name. Default value is `environment`
               * `default_environment_reference.uuid` - (Required) The UUID of a environment
               * `default_environment_reference.name` - (Optional/Computed) The name of a environment.
